...
const HeroSection = React.forwardRef<HTMLDivElement, HeroSectionProps>(
    ({ className, logo, slogan, title, subtitle, callToAction, backgroundImage, backgroundVideo, contactInfo }, ref) => {
        ...
        return (
            ...
            >
                ...
                <div className="flex w-full flex-col justify-between p-8 md:w-1/2 md:p-12 lg:w-3/5 lg:p-16">
                    ...
                    <div>
                        <motion.header className="mb-12" variants={itemVariants}>
                            ...
                            {!logo && slogan && (
                                <p className="text-xs tracking-wider text-muted-foreground uppercase">{slogan}</p>
                            )}
                        </motion.header>
                ...
                {/* Right Side: Video or Image with Clip Path Animation */}
                <motion.div
                    className="relative w-full min-h-[300px] md:w-1/2 md:min-h-full lg:w-2/5 overflow-hidden"
