        ...
        <main className="min-h-screen bg-white">
            ...
            <section className="relative min-h-[80vh] h-auto flex items-center justify-center overflow-hidden bg-[#092963] pb-16">
                <div className="absolute inset-0 z-0">
                    <div className="absolute inset-0 bg-gradient-to-br from-[#092963] to-[#ec4899] mix-blend-multiply z-10" />
                    <Image
                        src="/images/ai-chatbots.png"
                        alt="AI Chatbots Background"
                        fill
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        <div className="order-2 md:order-1">
                            <div className="relative h-80 rounded-2xl overflow-hidden shadow-xl">
                                <Image
                                    src="/images/ai-chatbots.png"
                                    alt="Chatbot Interface Visualization"
                                    fill
